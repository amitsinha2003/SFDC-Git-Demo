...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>TKR increment reopened count</fullName>
        <actions>
    ...
    <rules>
        <fullName>TKR_Defect Release Completeness</fullName>
        <actions>
        ...
        <criteriaItems>
            <field>TKR_Bug__c.Release_Steps_Automated__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>TKR_Bug__c.Release_Comment__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>TKR_Bug__c.Fix_in_Environment__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>TKR_Bug__c.Version__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>TKR_Bug__c.Validation_Steps__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
    ...
    <rules>
        <fullName>TKR_Defect Release Completeness - Uncheck</fullName>
        <actions>
